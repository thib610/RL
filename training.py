...
p2 = classes.Agent_class.Agent(1)
...
for i in range(0, nb_games):
    if i % 1000 == 0:
        print(i)
    classes.Tictactoe_class.ia_versus(p1, p2)
end = timer()
print("training time", end - start)

# save q_values of agents, check
# p1 agent
with open('agent_model/P1_IA.pickle', 'wb') as handle:
...
# p2 agent
with open('agent_model/P2_IA.pickle', 'wb') as handle:
